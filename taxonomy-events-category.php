	...
	<div class="events_categories ">
		<div class="taxlist wrapper">
			...
			foreach($wcatTerms as $wcatTerm) : 	?>
				...
				<li <?php if($current_term == $wcatTerm->name){ echo 'class="active"';} else {echo 'class=""';} ?>>
					<a href="<?php echo get_term_link( $wcatTerm->slug, $wcatTerm->taxonomy ); ?>" class="event_category_link"><?php echo $wcatTerm->name; ?></a>
				</li>
